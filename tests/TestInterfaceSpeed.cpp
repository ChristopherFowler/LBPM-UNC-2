...
//	printf("Cos(theta_wns) = %f, Analytical = %f \n",efawns/lwns,1.0*RADIUS/CAPRAD);
	printf("Interface Velocity = %f,%f,%f \n",Averages->vwn_global(0),Averages->vwn_global(1),Averages->vwn_global(2));
	printf("Common Curve Velocity = %f,%f,%f \n",Averages->vwns_global(0),Averages->vwns_global(1),Averages->vwns_global(2));
	printf("-------------------------------- \n");	
	//.........................................................................	
	...
	if ( fabs(Averages->vwn_global(2)+0.25) > 0.01){
		printf("TestInterfaceSpeed: Error too high for kinematic velocity of wn interface \n");
		toReturn = 6;
	}
	if ( fabs(Averages->vwns_global(2)+0.25) > 0.01){
